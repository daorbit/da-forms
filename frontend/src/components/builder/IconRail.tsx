...
import { IconCircleCheck, IconCode, IconAdjustmentsHorizontal, IconPalette, IconListNumbers, IconMail, IconCreditCard, IconRobot } from '@tabler/icons-react';
...
const items: { id: RailPanel; label: string; icon: typeof IconCode }[] = [
  { id: 'ai', label: 'Edit with AI', icon: IconRobot },
